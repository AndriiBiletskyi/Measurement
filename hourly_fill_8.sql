...
declare @time_to_count datetime = '2021.12.11 13:00:00';
declare @cnt int = 1;
...
begin
	...
	insert into pomiary.dbo.hourly_8 (ID,Czas,P_day,Q_day) values (@cnt,@time_from,@P_res,@Q_res);
