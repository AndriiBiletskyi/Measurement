...
declare @time_from datetime = '2021.12.03 00:00:00';
declare @time_to_count datetime = '2021.11.11 23:59:59';
declare @cnt int = 1;
...
begin
	set @time_to = DATEADD(day, 1, @time_from);
	set @time_to_cnt = @time_to;
	set @P_res_min = (select top 1 [P_day]
	from pomiary.dbo.EQ_6
	...
	insert into pomiary.dbo.daily_6(ID,Czas,P_day,Q_day) values (@cnt,@time_from,@P_res,@Q_res);
